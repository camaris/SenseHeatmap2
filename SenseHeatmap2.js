...
//			 		"Metric2":d[2].qNum
//			 	}
				return new Array(d[1].qNum,d[2].qNum,10);
			});
...
console.log("Heatmap step 1 : Start Heatmap");
...
console.log("Heatmap step 2 : "+extension.toString());
...
var heat = simpleheat('McaHeatMap').data(data).max(18),
    frame;
...
//get('McaHeatMap').onmousemove = function (e) {
